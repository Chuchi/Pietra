...
public class BluetoothService {
    ...
    private static final String TAG = "com.romane.piedra";
    ...
    public BluetoothService(Context context, Handler handler, BluetoothAdapter adapter)
    {
        ...
        UUID_SEGURO = BTMODULEUUID;
        UUID_INSEGURO = BTMODULEUUID;
    }
    ...
    // Consigue el nombre del dispositivo Bluetooth conectado
