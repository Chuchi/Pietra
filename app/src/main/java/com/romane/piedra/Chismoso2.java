...
public class Chismoso2 extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Intent intentMemoryServiceII = new Intent(context, Actualiza.class);

        if (petrus) {
            if(!EstaActualizaTrabajando){context.startService(intentMemoryServiceII);}
        }else{
            context.stopService(intentMemoryServiceII);
        }
    }
